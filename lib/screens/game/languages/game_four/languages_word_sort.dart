import 'dart:async';
import 'dart:math';
import 'package:brain_application/data/data_language/list_question_four.dart';
import 'package:flutter/material.dart';
import 'package:brain_application/theme_color/light_colors.dart';
import 'package:brain_application/values/share_data.dart';
    ...
    if (loop != null) {
      ...
      if (next &&
        ...
        if (indexQues != 0 &&
            indexQues > best &&
            indexQues < listQuestions.length - 1) {
          best++;timeHint = false;setEndTimer();
        }
        ...
        indexQues--;timeHint = false;setEndTimer();
