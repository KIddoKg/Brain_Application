...
import 'package:brain_application/screens/admin/card_info/SizeConfig.dart';
                            ...
                            Column(
                              children: <Widget>[
                                _buildFruitCard(
                                    "Game 1",
                                    "Level cao nhất: ",
                                    "Level: ${user.level_Attention1}",
                                    "Điểm: ${user.score_Attention1}",
                                    0xffF7DFB9,
                                    0XffFAF0DA),
                                SizedBox(
                                ...
                                GestureDetector(
                                  child: _buildFruitCard(
                                      "Game 2",
                                      "Level cao nhất: ",
                                      "Level: ${user.level_Attention2}",
                                      "Điểm: ${user.score_Attention2}",
                                      0xffC4D4A3,
                                      0XffE0E8CF),
                                ),
                              ],
                            ...
                            Column(
                              children: <Widget>[
                                ...
                                _buildFruitCard(
                                    "Game 3",
                                    "Level cao nhất: ",
                                    "Level: ${user.level_Attention3}",
                                    "Điểm: ${user.score_Attention3}",
                                    0xffFFC498,
                                    0XffFDDCC1),
                                SizedBox(
                                  height: 2 * SizeConfig.heightMultiplier,
