import 'package:brain_application/models/tile_model_one.dart';

bool selected = false;
List<TileModel> pairs = [];
List<TileModel> visible = [];
...
double arg_time = 0;
double totalScore = 0;
// List<TileModel> correct = getCorrect();
...
// List<TileModel> getCorrect() {
//   List<TileModel> pairs = [
//     TileModel(imageAssetPath: "asset/correct.png", isSelected: false)
//   ];
//   return pairs;
// }
