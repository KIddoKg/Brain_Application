...
import 'package:brain_application/screens/walkthrough/on_boarding.dart';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';
import 'package:liquid_swipe/liquid_swipe.dart';
import 'package:brain_application/models/model_onboarding.dart';
  ...
  final pages = [
    OnBoardingPageWidget(
      model: OnBoardingModel(
        image: "assets/gif/game_languages_1-1.gif",
    ...
    OnBoardingPageWidget(
      model: OnBoardingModel(
        image: "assets/gif/game_languages_1-2.gif",
    ...
    OnBoardingPageWidget(
      model: OnBoardingModel(
        image: "assets/gif/game_languages_1-3.gif",
